...
{
    public class SkladnikiPrzepisuBL_ : ISkladnikiPrzepisuBL
    {

        private readonly UnitOfWorkTest unitOfWork;

        public SkladnikiPrzepisuBL_(UnitOfWorkTest unitOfWork)
        {
            this.unitOfWork = unitOfWork;
        }
        public SkladnikiPrzepisuBL_()
        {
        ...
        else throw new ArgumentException("błędne id przepisu lub skladnika"+p+" "+w);
        }
